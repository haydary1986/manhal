...
func DefaultRules() *Rules {
	return &Rules{
		...
		Activities: []Activity{
			...
			{Key: "union_academics", Label: "عضوية نقابة الأكاديميين", Table: 2, Points: t2(3), Cap: 6},
			...
			// --- بقية بنود الجدول الثاني الرسمي (تعليمات 2025-2026) ---
			{Key: "review_eval_in", Label: "تقييم بحث/كتاب/رسائل — داخل العراق", Table: 2, Points: t2(1), Cap: 5},
			{Key: "review_eval_out", Label: "تقييم بحث/كتاب/رسائل — خارج العراق", Table: 2, Points: t2(2), Cap: 6},
			{Key: "seminar_committee", Label: "لجنة ندوة/ورشة عمل", Table: 2, Points: t2(1), Cap: 5},
			{Key: "new_dept_committee", Label: "لجنة استحداث قسم علمي", Table: 2, Points: t2(1), Cap: 5},
			{Key: "training_lecturer", Label: "محاضر في دورة تدريبية/تعليم مستمر", Table: 2, Points: t2(1), Cap: 5},
			{Key: "edu_guidance", Label: "إرشاد/إشراف تربوي", Table: 2, Points: t2(1), Cap: 5},
			{Key: "extracurricular", Label: "إشراف نشاط لامنهجي للطلبة", Table: 2, Points: t2(1), Cap: 5},
			{Key: "dorm_supervision", Label: "الإشراف على الأقسام الداخلية", Table: 2, Points: t2(2), Cap: 6},
			{Key: "intl_cooperation", Label: "تعاون تربوي مع جامعات/منظمات عالمية", Table: 2, Points: t2(2), Cap: 6},
			{Key: "teaching_hospital", Label: "العمل في المستشفيات التعليمية (سريري)", Table: 2, Points: t2(15), Cap: 15},
			{Key: "sports_activity", Label: "الإسهام في الأنشطة الرياضية للوزارة", Table: 2, Points: t2(2), Cap: 2},
			{Key: "graduate_employment", Label: "الإسهام في توظيف الخريجين", Table: 2, Points: t2(1), Cap: 5},
			{Key: "inventory_committee", Label: "لجنة جرد", Table: 2, Points: t2(1), Cap: 3},
			{Key: "perf_eval_70", Label: "معدل تقييم الأداء (70–79)", Table: 2, Points: t2(4), Cap: 4},
			{Key: "perf_eval_80", Label: "معدل تقييم الأداء (80–89)", Table: 2, Points: t2(6), Cap: 6},
			{Key: "perf_eval_90", Label: "معدل تقييم الأداء (90–99)", Table: 2, Points: t2(8), Cap: 8},
			{Key: "creative_work", Label: "نشاطات إبداعية/أعمال مميّزة", Table: 2, Points: t2(1), Cap: 2},
		},
	}
}
