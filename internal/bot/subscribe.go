...
func premiumBenefits() []string {
	return []string{
		"📄 محادثة الـ PDF (اسأل ورقتك واحصل على إجابات مدعّمة)",
		"🎬 توليد عرض تقديمي (PowerPoint) من ورقتك أو نصّك",
		"🎤 تحضير مناقشة الرسالة (أسئلة لجنة محتملة وأجوبة)",
		"📖 مراجعة الأدبيات و🧩 كشف الفجوة البحثية",
		"🌐 البحث الذكي في الويب و▶️ تلخيص فيديوهات يوتيوب",
		"📄↔Word مع OCR للملفات الممسوحة ضوئياً",
		"إعادة الكتابة البشرية لملفات Word كاملة (لا النص فقط)",
		"حدود استخدام يومية أعلى للأدوات الذكية (أو بلا حدود) + أولوية بالدعم",
	}
}
